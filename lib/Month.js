    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'rbc-date-cell total-col', style: (0, _eventLevels2.segStyle)(1, 8) },
            _react2.default.createElement(
              'span',
              null,
              (0, _flattenDeep2.default)(levels).length + extra.length
            )
          )
        ),
  ...
  _headers: function _headers(row, format, culture, totalEvents) {
    ...
    headers.push(_react2.default.createElement(
      'div',
      {
        ...
        style: _extends({}, style, { fontSize: '22px', flextDirection: 'column', whiteSpace: 'initial' })
      },
      _react2.default.createElement(
        'span',
        { style: { color: '#fff' } },
