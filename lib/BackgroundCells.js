...
var DisplayCells = function (_React$Component) {
  ...
  DisplayCells.prototype.render = function render() {
    var _props = this.props,
        slots = _props.slots,
        row = _props.row,
        eventsCount = _props.eventsCount;
      ...
      children.push(_react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('rbc-day-bg', {
            ...
            'total-col': i === 7,
            'rbc-now': _dates2.default.eq(row[i], new Date(), 'day')
          })
        },
        i === 7 && _react2.default.createElement(
          'span',
          null,
          eventsCount
        )
...
DisplayCells.propTypes = {
  ...
  eventsCount: _react2.default.PropTypes.number
};
