...
function eventSegments(event, first, last, _ref) {
  ...
  var start = _dates2.default.max((0, _accessors.accessor)(event, startAccessor).startOf('day').toDate(), first);
  var end = _dates2.default.min((0, _accessors.accessor)(event, endAccessor).endOf('day').toDate(), last);
...
function inRange(e, start, end, _ref2) {
  ...
  var eStart = (0, _accessors.accessor)(e, startAccessor).startOf('day');
  var eEnd = (0, _accessors.accessor)(e, endAccessor).endOf('day');

  var startsBeforeEnd = eStart.isSameOrBefore(end, 'day');
  var endsAfterStart = eEnd.isSameOrAfter(start, 'day');
